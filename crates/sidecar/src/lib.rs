...
pub mod contract;
pub mod grants;
// Generated by meridian-design from the matrix; its layout is the generator's.
#[rustfmt::skip]
mod operations;
mod service;
mod typed;
...
pub use meridian_pb::plugin::v1::plugin_operations_server::PluginOperationsServer;
