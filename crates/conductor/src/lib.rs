...
//! instrument store to apply through its own path. `make check-crate-boundaries` refuses
...
//! the instrument store does not hold it. Nothing has to ask this component anything,
